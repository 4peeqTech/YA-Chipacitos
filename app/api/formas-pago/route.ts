...
export async function POST(req: NextRequest) {
  ...
  if (e) { console.error(e); return NextResponse.json({ error: 'No se pudo crear la forma de pago' }, { status: 500 }) }
  return NextResponse.json(data)
}
export async function PATCH(req: NextRequest) {
  ...
  if (e) { console.error(e); return NextResponse.json({ error: 'No se pudo actualizar la forma de pago' }, { status: 500 }) }
  return NextResponse.json(data)
}
export async function DELETE(req: NextRequest) {
  ...
  if (e) { console.error(e); return NextResponse.json({ error: 'No se pudo eliminar la forma de pago' }, { status: 500 }) }
