...
import StockTerminadoAdminClient, { ProductoTerminado, Movimiento } from './StockTerminadoAdminClient'

export const metadata = { title: 'Fábrica · Stock terminado | YA! Chipacitos' }

export default async function AdminFabricaStockTerminadoPage() {
  ...
  return <StockTerminadoAdminClient itemsIniciales={items} movimientosIniciales={movimientosIniciales} />
}
