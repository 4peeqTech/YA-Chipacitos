...
-- ── Informes diarios ─────────────────────────────────────────────────
-- No es una tarea: es un envío puntual a un destinatario elegido con
-- la lista (snapshot) de tareas que el autor completó ese día + un
-- comentario libre opcional. Vive en tabla propia para no mezclar su
-- ciclo de vida con el de "tareas" (no pasa por el board/lista).
